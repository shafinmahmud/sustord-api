...
public class AcademicInfoService extends StudentIdentityService {
    ...
    public AcademicProfile getAllAcademicInfo(){
        ...
        academic.setSchoolName(this.getStudentSchoolName());
        academic.setDepartmentName(this.getStudentDepartmentName());
        academic.setDegreeType(this.getStudentDegreeType());
        academic.setDegreeCategory(this.getStudentDegreeCategory());
        academic.setProgramName(this.getStudentProgramName());
